...
CREATE TABLE "student"("id" SERIAL PRIMARY KEY ,"name" varchar(200) , "email" varchar(200)  ,"university_id" int ,"user_id" int);
INSERT INTO "student" values (1,'Bob', 'bob@xyz.com',3,1);
INSERT INTO "student" values (2,'Rob', 'rob@abc.com',2,1);
INSERT INTO "student" values (3,'Joe', 'joe@xyz.com',1,2);
